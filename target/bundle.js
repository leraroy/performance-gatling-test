var gatling = (() => {
  ...
  var require_closedInjection = __commonJS({
    "node_modules/@gatling.io/core/target/closedInjection.js"(exports) {
      ...
      var rampConcurrentUsers2 = (from) => wrapClosedInjectionStepRamp(jvm_types_1.CoreDsl.rampConcurrentUsers(from));
      exports.rampConcurrentUsers = rampConcurrentUsers2;
  ...
  var require_openInjection = __commonJS({
    "node_modules/@gatling.io/core/target/openInjection.js"(exports) {
      ...
      var stressPeakUsers2 = (users) => wrapOpenInjectionStepStressPeak(jvm_types_1.CoreDsl.stressPeakUsers(users));
      exports.stressPeakUsers = stressPeakUsers2;
  ...
  var test_gatling_default = (0, import_core.simulation)((setUp) => {
    const httpProtocol = import_http.http.baseUrl("https://api.clickup.com/api/v2").acceptHeader("application/json").acceptHeader("application/json").authorizationHeader(
    ...
    setUp(
      scn1.injectOpen(
        ...
        (0, import_core.stressPeakUsers)(100).during(5),
        (0, import_core.constantUsersPerSec)(10).during(20)
      ).protocols(httpProtocol),
      scn2.injectOpen(
        (0, import_core.constantUsersPerSec)(20).during(20),
        (0, import_core.rampUsers)(100).during(30)
      ).protocols(httpProtocol)
    );
  });
